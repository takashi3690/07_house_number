...
require_once __DIR__ . '../../../Models/categories/edit.php';
        ...
        <div class="container">
            ...
            <div class="main-content">
                ...
                <section class="profile-section">
                    <div class="user-info">
                        <form action="../../Models/categories/update_category.php" method="post">
                            <input type="hidden" name="id" value="<?= htmlspecialchars($category['id']) ?>">
                            <input type="text" name="name" value="<?= htmlspecialchars($category['name']) ?>" required>
                            <p><input type="submit" value="更新" class="add-category-btn"></p>
                        </form>
                    </div>
                </section>
            </div>
